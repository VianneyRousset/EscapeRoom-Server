...
(function() {
  ...
  define(function() {
    ...
    return Communication = (function() {
      ...
      Communication.prototype.listen = function() {
      ...
      Communication.prototype.get_init_tree = function() {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            return setTimeout(function() {
              return resolve(_this.tmp_init_tree());
            }, 2000);
          };
        })(this));
      };

      Communication.prototype.tmp_init_tree = function() {
